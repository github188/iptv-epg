...
var GCL_CHANNEL_DATA_DOMIAN = 'http://192.168.88.36/clist/data/channel.json';

// 测试入口页面
var GCL_TEST_ENTRY_PAGE = 'http://192.168.88.36/clist/entry.html'
...
var GCL_TEST_LINKS = [
    {   // 认证入口
        ...
        link: 'http://192.168.88.36/clist/index2.html',
        icon: '<i class="fa fa-youtube-play" aria-hidden="true"></i>',
        text: '直播页面'
    }, {    // 无MP直播页面
        link: 'http://192.168.88.36/clist/index-bw.html',
